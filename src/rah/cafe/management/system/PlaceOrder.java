...
public class PlaceOrder extends javax.swing.JFrame {
    ...
    public void productNameByCategory(String category) {
        ...
        dtm.setRowCount(0);
        ArrayList<NewProduct> list = NewProductDao.getAllRecordsByCategory(category);
        Iterator<NewProduct> itr = list.iterator();
        while (itr.hasNext()) {
            NewProduct productObj = itr.next();
    ...
    public void filterProductByname(String name, String category) {
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        dtm.setRowCount(0);
        ArrayList<NewProduct> list = NewProductDao.filterProductByname(name, category);
        Iterator<NewProduct> itr = list.iterator();
        while (itr.hasNext()) {
            NewProduct productObj = itr.next();
            dtm.addRow(new Object[]{productObj.getName()});
    ...
    public void validateFields() {
        ...
        if (!customerName.equals("") && !customerMobileNumber.equals("") && customerMobileNumber.matches(mobileNumberPattern) && customerMobileNumber.length() == 11 && !customerEmail.equals("") && customerEmail.matches(emailPattern) && grandTotal > 0) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(1315, 25, 39, -1));
        ...
        lblBillID.setText("--");
        getContentPane().add(lblBillID, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 110, -1, -1));
        ...
        getContentPane().add(txtCusName, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, 220, -1));
        ...
        txtCusMobileNumber.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        txtCusMobileNumber.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtCusMobileNumberKeyReleased(evt);
            }
        });
        getContentPane().add(txtCusMobileNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 290, 220, -1));
        ...
        getContentPane().add(txtCusEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 370, 220, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 150, 220, -1));
        ...
        getContentPane().add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 220, 220, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 270, 220, 418));
        ...
        getContentPane().add(txtProName, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 150, 220, -1));

        jLabel11.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Quantity");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 190, -1, -1));
        ...
        getContentPane().add(jSpinner1, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 220, 220, -1));

        jLabel12.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Price");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 110, -1, -1));

        txtProPrice.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        getContentPane().add(txtProPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 150, 220, -1));

        jLabel13.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Total");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 190, -1, -1));

        txtProTotal.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        getContentPane().add(txtProTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 220, 220, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 260, -1, -1));
        ...
        getContentPane().add(btnAddToCart, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 260, -1, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 310, 498, 371));
        ...
        getContentPane().add(lblGrandTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 710, -1, -1));
        ...
        getContentPane().add(btnGenerateBill, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 700, -1, -1));

        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/place_order_bg.jpg"))); // NOI18N
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        NewProduct product = NewProductDao.getProductByname(productName);
    ...
    private void btnGenerateBillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerateBillActionPerformed
        ...
        try {
            ...
            doc.open();
            Paragraph cafeName = new Paragraph("                                                     Rah Cafe Management System\n");
            doc.add(cafeName);
            Paragraph highPhen1 = new Paragraph("--------------------------------------------------------------------------------------------------------------------------\n");
            doc.add(highPhen1);
            Paragraph highPhen2 = new Paragraph("--------------------------------------------------------------------------------------------------------------------------\n");
            doc.add(highPhen2);
            Paragraph cusBill = new Paragraph("Bill ID: " + billId + "                                                     " + "Date: " + date + "\nCustomer Name: " + customerName + "\nTotal Paid: " + grandTotal + "\n");
            doc.add(cusBill);
            doc.add(highPhen1);
            ...
            doc.add(tb1);
            doc.add(highPhen1);
            Paragraph thanks = new Paragraph("Thank You " + customerName + "! Please Visit Again!");
            doc.add(thanks);
